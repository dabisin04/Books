...
class _ProfileScreenContent extends StatelessWidget {
  ...
  final dynamic user; // Ajusta el tipo según tu modelo de usuario
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextField(
                      ...
                      onChanged: (value) {
                        // Forzar reconstrucción si cambia la búsqueda
                        // (Opcionalmente podrías usar un BlocListener para actualizar)
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Dismissible(
                                ...
                                child: GestureDetector(
                                  ...
                                  // Envolvemos el widget en un Container para que ocupe todo el ancho
                                  child: Container(
